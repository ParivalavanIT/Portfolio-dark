  ...
  (() => {
    ...
    function o(e) {
      for (; e.children && e.children.length > 0; )
        o(e.children[0]), e.remove(e.children[0]);
      ...
      onInit() {
        ...
        this.p5 = new l(function(t) {
          ...
          function a(e, i, s) {
            ...
            return (
              o < 0 && (o += t.TWO_PI),
              t.noise(n + t.cos(o) * i, r + t.sin(o) * i, h + s)
            );
          }
          (t.setup = function() {
            e.initP5(t),
              t.strokeWeight(1),
              t.stroke(s(e.options.color)),
              t.smooth(),
              t.noFill();
          }),
            (t.draw = function() {
                ...
                (function() {
                  ...
                  for (let i = 0; i < o; i++) {
                    ...
                    for (let s = 0; s < 360; s++) {
                      let o = t.radians(s),
                        n =
                          20 * e.options.chaos * a(o, 0.12 * i + 0.2, h) +
                          (4 * i + 50) +
                          (i * e.options.spacing || 0);
